...
model_path = "models/rembert/rembert_language_classifier2"


checkpoint_path = "results_rembert_overfit/checkpoint-11279"

# Charger le modèle depuis ce checkpoint
...
df.to_csv('predictions/predictions_rembert2.csv', index=False)
